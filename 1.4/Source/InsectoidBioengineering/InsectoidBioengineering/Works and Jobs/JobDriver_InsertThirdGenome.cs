...
{
    public class JobDriver_InsertThirdGenome : JobDriver
    {
        ...
        public override void Notify_PatherFailed()
        {
            ...
            building_incubator.ExpectingThirdGenome = false;
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            yield return new Toil
            {
                initAction = delegate
                {
                    ...
                    building_incubator.TryAcceptThirdGenome(this.job.targetB.Thing, true);
                    building_incubator.ExpectingThirdGenome = false;
