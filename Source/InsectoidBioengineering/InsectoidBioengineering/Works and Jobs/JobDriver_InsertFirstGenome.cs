...
{
    public class JobDriver_InsertFirstGenome : JobDriver
    {
        ...
        public override void Notify_PatherFailed()
        {
            ...
            building_incubator.ExpectingFirstGenome = false;
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            yield return new Toil
            {
                initAction = delegate
                {
                    ...
                    building_incubator.TryAcceptFirstGenome(this.job.targetB.Thing, true);
                    building_incubator.ExpectingFirstGenome = false;
